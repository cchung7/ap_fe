...
import { ArrowUpRight, LayoutDashboard, CalendarPlus } from "lucide-react";
...
const actions: Action[] = [
  {
    ...
    description: "Return to the main admin dashboard overview and recent activity feed.",
    href: "/admin",
    icon: <LayoutDashboard className="h-4.5 w-4.5" />,
  },
  {
    title: "Manage All Events",
    description: "Switch to event operations to review schedules, capacity, and registrations.",
    href: "/admin/events",
...
export function MembersQuickActions() {
  return (
    <section className="flex min-w-0 h-full min-h-0 flex-col overflow-hidden rounded-[1.55rem] border border-border/60 bg-white/72 shadow-master backdrop-blur-md">
      <div className="border-b border-border/60 px-5 py-4.5 sm:px-6 sm:py-5">
        ...
        <p className="mt-1 text-[13px] leading-6 text-muted-foreground">
          Jump directly into related admin workflows.
        </p>
      </div>
