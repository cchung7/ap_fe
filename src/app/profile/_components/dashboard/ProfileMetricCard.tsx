// D:\ap_fe\src\app\profile\_components\dashboard\ProfileMetricCard.tsx
"use client";
    ...
    >
      <div className="flex items-start justify-between gap-3 px-4 py-4 sm:px-5 sm:py-5">
        <div className="min-w-0 space-y-2">
          <div className="text-[11px] font-semibold uppercase leading-snug tracking-[0.14em] text-muted-foreground sm:text-[12px]">
            {title}
          </div>
